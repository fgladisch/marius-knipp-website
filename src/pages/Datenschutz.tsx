      ...
      <main className="container pt-40 pb-20">
        ...
        <div className="max-w-[800px] space-y-8 text-body leading-relaxed">
          <section>
            ...
            <h3 className="text-h5 md:text-h4 mb-3">Allgemeine Hinweise</h3>
            <p className="mb-4">
            ...
            <h3 className="text-h5 md:text-h4 mb-3">
          ...
          <section>
            <h2 className="text-h4 md:text-h3 mb-4">2. Hosting</h2>
            <p className="mb-4">
              Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
            </p>

            <h3 className="text-h5 md:text-h4 mb-3">Externes Hosting</h3>
            <p className="mb-4">
          ...
          <section>
            ...
            <h3 className="text-h5 md:text-h4 mb-3">Datenschutz</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              Marius Lorenzo Knipp
              <br />
              Volksgartenstra&szlig;e 18
              <br />
              40227 D&uuml;sseldorf
            </p>
            <p className="mb-4">
              Telefon: +491704491665
              <br />
              E-Mail: info@mariusknipp.de
            </p>
            <p className="mb-4">
            ...
            <h3 className="text-h5 md:text-h4 mb-3">Speicherdauer</h3>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              die jeweils im Einzelfall einschl&auml;gigen Rechtsgrundlagen wird
              in den folgenden Abs&auml;tzen dieser
            ...
            <p className="mb-4 uppercase font-bold text-sm">
            ...
            <p className="mb-4">
              ...
              gew&ouml;hnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts
              des mutma&szlig;lichen Versto&szlig;es zu. Das Beschwerderecht
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              Durchf&uuml;hrung vorvertraglicher Ma&szlig;nahmen erforderlich
              ist. In allen &uuml;brigen F&auml;llen beruht die Verarbeitung
              auf unserem berechtigten Interesse an der effektiven Bearbeitung
              der an uns gerichteten Anfragen (Art. 6 Abs. 1 lit. f DSGVO) oder
              auf Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) sofern diese
